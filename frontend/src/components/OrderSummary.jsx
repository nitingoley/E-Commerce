...
const OrderSummary = () => {
  ...
  //  const stripe_public_key = 'pk_test_51PSEXn06AQVECNmWRdEcjGQlQrNJAl3rYoZgY4masULx8v8gusoShdagWO81UEmDEJ0oDh2vEUh1VY2BGSi35jUE00sw3eyFEE'
  ...
  return (
    ...
    >
      <p className="text-sm font-bold text-emerald-400">Order summary</p>

      <div className="space-y-4">
        <div className="space-y-2">
          <dl className="flex items-center justify-between gap-4">
            <dt className=" text-sm font-normal text-gray-300">
              Original price
            </dt>
